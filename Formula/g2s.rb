class G2s < Formula
  ...
  version "0.98.019"
  url "https://github.com/GAIA-UNIL/G2S/archive/987fa4da46c8a3ac3636ad7eb9e8bc8367b2ec95.tar.gz"
  sha256 "6c7ef7327697704d9798530a81916e0f31c7971ddb129d8d7dfaa788b5a802c5"
  license "GPL-3.0-only"
    
  bottle do
    root_url "brew-bottles.open-geocomputing.org/"
    rebuild 1
    sha256 cellar: :any_skip_relocation, x86_64_linux: "7ab74fef5c37dbe5206458cb70f2a2fa8b62cc3d026c9e5717d894f5bc55b279"
  end
